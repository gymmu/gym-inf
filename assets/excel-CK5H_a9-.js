import{j as e}from"./react-vendor-DjasHgK6.js";import{a as s}from"./gym-pages-CcaJ2c6V.js";import{E as l}from"./Example-DUZ0e3gB.js";import{I as a}from"./Img-B1_nFrjF.js";import"./vendor-D7BjNmWU.js";import"./monaco-ByOCJtO_.js";import"./reveal-Rylxx4kG.js";import"./remotion-BRBWYm9w.js";const t="/gym-inf/assets/notentabelle-6xgMTh6X.png";function r(i){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Excel"}),`
...
`,e.jsx(n.h2,{children:"Tabellenkalkulation"}),`
`,e.jsxs(n.p,{children:[`Was aber ist Tabellenkalkulation. Das ist sehr schwer genau zu definieren, im
...
dann professionell mit einer Programmiersprache wie `,e.jsx(n.code,{children:"Python"}),` gemacht werden.
...
`,e.jsx(n.p,{children:`Die Tabellenkalkulation ist ein sehr mächtiges Werkzeug, und kann wie bereits
...
kennenlernen.`]}),e.jsx(n.p,{children:"Hier sehen Sie das Endresultat, wie diese Tabelle dann aussehen könnte."}),e.jsx(a,{src:t,imgStyle:{width:"80%"}}),e.jsx(n.p,{children:`Im Video weiter unten, können Sie die wichtigsten Teile von dieser Tabelle
Schritt-für-Schritt mitarbeiten.`})]}),`
`,e.jsx(n.h2,{children:"Videoanleitung"}),`
`,e.jsxs(n.p,{children:[`Hier finden Sie eine Anleitung wie man mit Excel umgehen kann und eine erste
Tabelle erstellen kann. Damit Sie dem Video auch folgen können, müssen Sie sich
zuerst noch bei Ihrer Schul-Onedrive anmelden: `,e.jsx(n.a,{href:"https://sblch-my.sharepoint.com/my",children:"https://sblch-my.sharepoint.com/my"})]}),`
`,e.jsx(s,{url:"wNUOuEa7fYc"}),`
...
`]}),`
`,e.jsx(n.h2,{children:"Gelerntes Abspeichern"}),`
`,e.jsxs(n.p,{children:[`Wenn Sie fertig sind mit dieser Tabelle und Sie diese für sich selbst angepasst
haben, dann halten Sie das gelernte in irgend einer Form fest. Am besten machen
Sie das mit `,e.jsx(n.a,{href:"https://obsidian.md",children:"Obsidian"}),` oder einem anderen Werkzeug das Sie
...
es für Sie schwer alles wieder zu finden.`]})]})}function k(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{k as default};
