import{r as a,j as e,e as g}from"./react-vendor-DjasHgK6.js";import{M as r,D as d}from"./gym-pages-CcaJ2c6V.js";import{E as l}from"./Example-DUZ0e3gB.js";import{u as j}from"./vendor-D7BjNmWU.js";import"./monaco-ByOCJtO_.js";import"./reveal-Rylxx4kG.js";import"./remotion-BRBWYm9w.js";const{hexy:w}=j;function f(){const[i,n]=a.useState("Hello World!"),[c,m]=a.useState({width:4,numbering:"none",format:"twos",radix:16}),o=a.useRef(null),s=t=>{m(u=>({...u,radix:t}))},x=t=>{n(t)};return e.jsxs("div",{style:{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",gap:"1rem"},children:[e.jsx("button",{onClick:()=>s(2),children:"Binary"}),e.jsx("button",{onClick:()=>s(8),children:"Octal"}),e.jsx("button",{onClick:()=>s(10),children:"Decimal"}),e.jsx("button",{onClick:()=>s(16),children:"Hexadecimal"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",gap:"1em"},children:[e.jsx(g,{defaultLanguage:"json",value:i,height:"300px",theme:"vs-dark",onChange:x,options:{minimap:{enabled:!1}}}),e.jsx("pre",{ref:o,style:{border:"1px solid black",width:"320px",height:"300px",marginRight:"1em",overflowY:"scroll"},children:w(i,c)})]})]})}function h(i){const n={code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Hexadezimalsystem"}),`
...
viel `,e.jsx(n.code,{children:"rot"}),", kein ",e.jsx(n.code,{children:"grün"})," und ein klein wenig ",e.jsx(n.code,{children:"blau"}),"."]})]})}function H(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(h,{...i})}):h(i)}export{H as default};
