import{j as e}from"./react-vendor-B6C3K7RQ.js";import{L as t,F as s}from"./gym-pages-51v9ty3M.js";import"./vendor-DID4YVBO.js";import"./monaco-B8ymEbop.js";function r(i){const n={br:"br",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"VPN - Virtual Private Network"}),`
...
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Die beste Kombination:"})," HTTPS + VPN + gesunder Menschenverstand beim Surfen!"]})]})}function o(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{o as default};
