import{r as s,j as e,h as w,i as A}from"./react-vendor-DPtW2uLn.js";import{E as k}from"./Editor-BjV_XeDN.js";import{S as u}from"./Select-Dywv8yvJ.js";import{S as C}from"./Slider-gTR9_wrp.js";import{s as i,B as G}from"./BoxModel-acIKIbb7.js";import{S as y}from"./gym-pages-DbdF9N1L.js";import"./vendor-BscfZStV.js";import"./monaco-DSiUpym4.js";import"./CodePen.module-BfICubSo.js";function M({htmlCode:o,cssCode:n}){const[g,v]=s.useState("white"),[a,p]=s.useState("black"),[d,b]=s.useState(32),[l,S]=s.useState(o),[r,j]=s.useState(n),[m,f]=s.useState(`
<html>
<body>${l}</body>
<style>${r}</style>
</html>
