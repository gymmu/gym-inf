import{j as e,r as l}from"./react-vendor-7TcISLYx.js";import{S as i}from"./gym-pages-NVZe8_t5.js";import"./vendor-BpcXj_Y6.js";import"./monaco-CPFjTESt.js";import"./reveal-Rylxx4kG.js";import"./remotion-D4ALPBen.js";function h({toggle:n,setToggle:t,labelText:r=""}){return e.jsx(e.Fragment,{children:e.jsxs("label",{children:[e.jsx("input",{type:"checkbox",value:n,onChange:()=>t(!n)}),r]})})}const u="_container_dw5dk_1",w="_gridContainer_dw5dk_5",k="_optionsContainer_dw5dk_10",b="_border_dw5dk_32",c={container:u,gridContainer:w,optionsContainer:k,border:b};function s({width:n="100%",children:t}){const[r,j]=l.useState(!1),[d,g]=l.useState(!1),[o,f]=l.useState(!1),[x,p]=l.useState(!1);return e.jsx("div",{className:c.container,children:e.jsxs("div",{className:c.gridContainer,children:[e.jsxs("div",{className:c.optionsContainer,children:[e.jsx(h,{labelText:"Gitter anzeigen",toggle:r,setToggle:j}),e.jsx(h,{labelText:"Hintergrund weiss",toggle:d,setToggle:g}),e.jsx(h,{labelText:"Rand anzeigen",toggle:x,setToggle:p}),e.jsx(h,{labelText:"Maximale Breite",toggle:o,setToggle:f})]}),e.jsx("div",{style:{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",width:"100%",flexGrow:1},children:e.jsxs("svg",{className:x?c.border:"",role:"img",viewBox:"0 0 300.5 300.5",xmlns:"http://www.w3.org/2000/svg",width:o?"100%":n,children:[e.jsx("title",{children:"SVG Image"}),e.jsxs("defs",{children:[e.jsx("pattern",{id:"smallGrid",width:"10",height:"10",patternUnits:"userSpaceOnUse",children:e.jsx("path",{d:"M 10 0 L 0 0 0 10",fill:"none",stroke:"gray",strokeWidth:"0.5"})}),e.jsxs("pattern",{id:"grid",width:"50",height:"50",patternUnits:"userSpaceOnUse",children:[e.jsx("rect",{width:"50",height:"50",fill:"url(#smallGrid)"}),e.jsx("path",{d:"M 50 0 L 0 0 0 50",fill:"none",stroke:"gray",strokeWidth:"1"})]})]}),d&&e.jsx("rect",{width:"100%",height:"100%",fill:"white"}),r&&e.jsx("rect",{width:"100%",height:"100%",fill:"url(#grid)"}),t]})})]})})}function a(n){const t={h2:"h2",h3:"h3",p:"p",strong:"strong",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Aufgaben"}),`
...
a -20 -20 1 0 0 -20 -20
h -180
a -20 20 1 0 0 -20 20`}),e.jsx("circle",{cx:"150",cy:"150",r:"50",fill:"none",stroke:"black",strokeWidth:"10"}),e.jsx("circle",{cx:"200",cy:"75",r:"10"})]})]})]})}function v(n={}){const{wrapper:t}=n.components||{};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}export{v as default};
