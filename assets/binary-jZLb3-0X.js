import{j as e}from"./react-vendor-7TcISLYx.js";import{M as i,D as t}from"./gym-pages-B7Tmaat0.js";import{E as a}from"./Example-DGKoSRAk.js";import"./vendor-BpcXj_Y6.js";import"./monaco-CPFjTESt.js";import"./reveal-Rylxx4kG.js";import"./remotion-D4ALPBen.js";const h="_wrapper_1672g_1",c="_tip_1672g_6",d={wrapper:h,tip:c};function s({tip:r,children:n}){return e.jsxs("div",{className:d.wrapper,children:[e.jsx("div",{className:d.tip,children:r}),n]})}function l(r){const n={code:"code",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Binärsystem"}),`
...
`,e.jsx(i,{children:String.raw`101011_\mathrm{Bin}`}),"."]})]})}function p(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(l,{...r})}):l(r)}export{p as default};
