import{r as s,j as e,h as w,i as A}from"./react-vendor-B6C3K7RQ.js";import{E as k}from"./Editor-cLaapLKI.js";import{S as u}from"./Select-Bj3R1vA1.js";import{S as C}from"./Slider-DqoIcTt6.js";import{s as i,B as G}from"./BoxModel-BqOKaanp.js";import{S as y}from"./gym-pages-BwB6KAce.js";import"./vendor-DID4YVBO.js";import"./monaco-B8ymEbop.js";import"./CodePen.module-BfICubSo.js";function M({htmlCode:o,cssCode:n}){const[g,v]=s.useState("white"),[a,p]=s.useState("black"),[d,b]=s.useState(32),[l,S]=s.useState(o),[r,j]=s.useState(n),[m,f]=s.useState(`
<html>
<body>${l}</body>
<style>${r}</style>
</html>
