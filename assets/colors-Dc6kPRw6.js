import{r as l,j as e,f as D}from"./react-vendor-7TcISLYx.js";import{E as B}from"./Example-BGbJjx5l.js";import"./vendor-BpcXj_Y6.js";import"./monaco-CPFjTESt.js";import"./reveal-Rylxx4kG.js";import"./gym-pages-NVZe8_t5.js";import"./remotion-D4ALPBen.js";const P="_container_evnjt_1",_="_colorinput_evnjt_10",z="_inputgroup_evnjt_19",C="_red_evnjt_25",y="_green_evnjt_28",E="_blue_evnjt_31",I="_huge_evnjt_35",N="_box_evnjt_43",r={container:P,colorinput:_,inputgroup:z,red:C,green:y,blue:E,huge:I,box:N};function L(){const[s,n]=l.useState("#000000"),[o,j]=l.useState("00"),[t,p]=l.useState("00"),[d,F]=l.useState("00");l.useEffect(()=>{n(`#${u(o)}${u(t)}${u(d)}`)},[o,t,d]);const u=i=>{let a=`${i}`;for(;a.length<2;)a=`0${a}`,console.log(a);return a},f=i=>{j(i.target.value)},S=i=>{p(i.target.value)},h=i=>{F(i.target.value)};return e.jsxs("div",{className:r.container,children:[e.jsx("div",{className:r.huge,children:"#"}),e.jsxs("div",{className:r.inputgroup,children:[e.jsx("label",{className:r.red,htmlFor:"red",children:"Rot"}),e.jsx("input",{className:r.colorinput,id:"red",maxLength:"2",type:"text",name:"red",value:o,onChange:f})]}),e.jsxs("div",{className:r.inputgroup,children:[e.jsx("label",{className:r.green,htmlFor:"green",children:"Grün"}),e.jsx("input",{className:r.colorinput,id:"green",maxLength:"2",type:"text",name:"green",value:t,onChange:S})]}),e.jsxs("div",{className:r.inputgroup,children:[e.jsx("label",{className:r.blue,htmlFor:"blue",children:"Blau"}),e.jsx("input",{className:r.colorinput,id:"blue",maxLength:"2",type:"text",name:"blue",value:d,onChange:h})]}),e.jsx("div",{className:r.huge,children:"="}),e.jsx("div",{className:r.box,style:{backgroundColor:s},children:" "})]})}function b({hex:s}){return e.jsx("div",{style:{backgroundColor:s,height:"1.5em",width:"1.5em"}})}function A({ppmS:s}){const[n,o]=l.useState(s),j=l.useRef(null),t=16;l.useEffect(()=>{if(!n)return;const d=n.split(`
`),[F,u,f,S]=d.slice(0,4);if(F!=="P3"){console.error("Unsupported PPM format");return}const h=d.slice(4).join(" ").split(" ").map(c=>parseInt(c,t)),i=j.current,a=i.getContext("2d");a.clearRect(0,0,i.width,i.height),a.imageSmoothingEnabled=!1;const w=parseInt(u,t)||1,v=parseInt(f,t)||1,m=a.createImageData(w,v);for(let c=0,x=0;c<h.length;c+=3,x+=4)m.data[x]=parseInt(h[c],t),m.data[x+1]=parseInt(h[c+1],t),m.data[x+2]=parseInt(h[c+2],t),m.data[x+3]=255;const g=document.createElement("canvas");g.width=w,g.height=v,g.getContext("2d").putImageData(m,0,0),a.drawImage(g,0,0,w,v,0,0,i.width,i.height)},[n]);const p=d=>{o(d)};return e.jsxs("div",{style:{display:"flex",alignItems:"center",flexDirection:"row",justifyContent:"center",width:"100%",gap:"1em"},children:[e.jsx(D,{defaultLanguage:"json",value:n,height:"300px",theme:"vs-dark",onChange:p,options:{minimap:{enabled:!1}}}),e.jsx("canvas",{ref:j,style:{border:"1px solid white",width:"300px",height:"300px",imageRendering:"pixelated"}})]})}function k(s){const n={code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Farben"}),`
...
Farbe.`]}),`
`]})]})]})}function U(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(k,{...s})}):k(s)}export{U as default};
