import{r as s,j as e,d as w,k as A}from"./react-vendor-7TcISLYx.js";import{s as i,B as G}from"./BoxModel-Df9brAYl.js";import{E as k}from"./Editor-Uw0LmkQV.js";import{S as u}from"./Select-DqyxwXvK.js";import{S as C}from"./Slider-DmcY0Tyu.js";import{S as y}from"./gym-pages-B7Tmaat0.js";import"./vendor-BpcXj_Y6.js";import"./monaco-CPFjTESt.js";import"./reveal-Rylxx4kG.js";import"./CodePen.module-Clum2mVG.js";import"./remotion-D4ALPBen.js";function M({htmlCode:o,cssCode:n}){const[g,p]=s.useState("white"),[a,v]=s.useState("black"),[d,b]=s.useState(32),[l,S]=s.useState(o),[r,j]=s.useState(n),[m,f]=s.useState(`
<html>
<body>${l}</body>
<style>${r}</style>
</html>
...
.flex-wrapper > div {
    ...
    flex-shrink: ${D};
    flex-basis: auto;
}`;N(x)},[a,d,l,r,m,t,h,D]);function N(x){p(x),n(`<html>
    <body>${z}</body>
    <style>${x}</style>
    <style>
body {
...
.flex-wrapper > div {
    ...
    align-content: ${r};
    justify-content: ${m};
}`;c(h)},[a,d,l,r,m]);function c(h){p(h),n(`<html>
    <body>${t}</body>
    <style>${h}</style>
    <style>
body {
...
.grid-wrapper > div {
    ...
    grid-template-areas:
        ...
        "aside main"
        "footer footer";
}`)},[a,d,l,r]);function f(t){p(t),n(`<html>
    <body>${m}</body>
    <style>${t}</style>
    <style>
body {
...
sogenannte Bento-Grids erstellen.`})]})]})}function _(o={}){const{wrapper:n}=o.components||{};return n?e.jsx(n,{...o,children:e.jsx(B,{...o})}):B(o)}export{_ as default};
