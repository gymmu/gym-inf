import{j as e,r as o,h as Q,b as X,d as ze}from"./react-vendor-DPtW2uLn.js";import{t as ce}from"./vendor-BscfZStV.js";function m({children:t,classes:s=""}){return e.jsx("div",{className:`full-width content-grid highlight ${s}`,children:t})}const ye="_inline_1yelo_1",_e="_display_1yelo_5",Ee="_wrapper_1yelo_9",se={inline:ye,display:_e,wrapper:Ee};function oe({children:t}){const s=o.useRef(null);return o.useEffect(()=>{ce.render(t,s.current,{throwOnError:!1})},[s]),e.jsx("span",{className:se.inline,ref:s,children:t})}function Le({children:t}){const s=o.useRef(null);return o.useEffect(()=>{ce.render(t,s.current,{displayMode:!0,throwOnError:!1})},[s]),e.jsx("div",{className:se.wrapper,children:e.jsx("div",{ref:s,className:se.display,children:t})})}function te({children:t}){return e.jsxs("div",{className:"highlight learning full-width content-grid",children:[e.jsx("h2",{id:"goals",children:"Lernziele"}),t]})}function D({url:t}){return e.jsx("center",{children:e.jsx("iframe",{width:"560",height:"315",src:`https://www.youtube.com/embed/${t}`,title:"YouTube video player",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0})})}const De="_container_mf5zg_2",Be="_codeBlockContainer_mf5zg_13",Te="_header_mf5zg_32",Fe="_leftHeader_mf5zg_43",Ae="_language_mf5zg_50",Ce="_exampleBadge_mf5zg_60",Ie="_hintBadge_mf5zg_73",Oe="_solutionBadge_mf5zg_86",Ne="_hintButton_mf5zg_99",$e="_solutionButton_mf5zg_123",Ze="_locked_mf5zg_146",Pe="_timer_mf5zg_160",Ke="_closeButton_mf5zg_172",We="_progressBar_mf5zg_192",He="_progressFill_mf5zg_200",Me="_solutionWrapper_mf5zg_211",Ve="_copyButton_mf5zg_226",x={container:De,codeBlockContainer:Be,header:Te,leftHeader:Fe,language:Ae,exampleBadge:Ce,hintBadge:Ie,solutionBadge:Oe,hintButton:Ne,solutionButton:$e,locked:Ze,timer:Pe,closeButton:Ke,progressBar:We,progressFill:He,solutionWrapper:Me,copyButton:Ve};function j({example:t,hint:s,solution:g,language:a="javascript",taskId:p}){const[z,T]=o.useState(!1),[f,W]=o.useState(!1),[F,u]=o.useState(!1),[y,E]=o.useState(!1),[L,S]=o.useState(30),[_,O]=o.useState(!1),[N,A]=o.useState(0),w=o.useRef(null),b=o.useRef(null),H=15,B=300;o.useEffect(()=>{if(!p||typeof window>"u"||typeof localStorage>"u")return;const k=`solution_lock_${p}`,C=localStorage.getItem(k);if(C){const h=Date.now(),I=parseInt(C,10);h<I?(O(!0),A(Math.ceil((I-h)/1e3))):localStorage.removeItem(k)}},[p]),o.useEffect(()=>{if(_&&N>0)return b.current=setInterval(()=>{A(k=>k<=1?(O(!1),p&&typeof window<"u"&&typeof localStorage<"u"&&localStorage.removeItem(`solution_lock_${p}`),b.current&&clearInterval(b.current),0):k-1)},1e3),()=>{b.current&&clearInterval(b.current)}},[_,N,p]),o.useEffect(()=>{if(f&&L>0)return w.current=setInterval(()=>{S(k=>{if(k<=1){if(W(!1),O(!0),p&&typeof window<"u"&&typeof localStorage<"u"){const C=Date.now()+B*1e3;localStorage.setItem(`solution_lock_${p}`,C.toString())}return A(B),w.current&&clearInterval(w.current),H}return k-1})},1e3),()=>{w.current&&clearInterval(w.current)}},[f,L,p]);const $=re(ie(t)),J=re(ie(s)),Z=re(ie(g)),U=async()=>{await navigator.clipboard.writeText($),u(!0),setTimeout(()=>u(!1),2e3)},M=async()=>{await navigator.clipboard.writeText(J),E(!0),setTimeout(()=>E(!1),2e3)},P=()=>{T(!z)},q=()=>{if(!_)if(f){if(W(!1),O(!0),w.current&&clearInterval(w.current),p){const k=Date.now()+B*1e3;localStorage.setItem(`solution_lock_${p}`,k.toString())}A(B),S(H)}else W(!0),S(H)},G=z||f,V=L/H*100,Y=k=>{const C=Math.floor(k/60),h=k%60;return`${C}:${h.toString().padStart(2,"0")}`};return e.jsxs("div",{className:x.container,children:[e.jsxs("div",{className:x.codeBlockContainer,children:[e.jsxs("div",{className:x.header,children:[e.jsxs("div",{className:x.leftHeader,children:[e.jsx("span",{className:x.language,children:a}),e.jsx("span",{className:x.exampleBadge,children:"Beispiel"})]}),e.jsx("button",{className:x.copyButton,onClick:U,"aria-label":"Code kopieren",title:"Code in Zwischenablage kopieren",children:F?"✓ Kopiert!":"Kopieren"})]}),e.jsx(Q,{language:a,style:X,showLineNumbers:!0,wrapLines:!0,customStyle:{margin:0,borderRadius:"0 0 8px 8px",fontSize:"0.9rem"},lineNumberStyle:{minWidth:"2.5em",paddingRight:"1em",color:"#928374",userSelect:"none"},children:$})]}),e.jsxs("div",{className:x.codeBlockContainer,children:[e.jsxs("div",{className:x.header,children:[e.jsx("div",{className:x.leftHeader,children:G?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:x.language,children:a}),e.jsx("span",{className:f?x.solutionBadge:x.hintBadge,children:f?"Lösung":"Hinweis"}),f&&e.jsxs("span",{className:x.timer,children:["⏱ ",L,"s"]}),e.jsx("button",{onClick:f?q:P,className:x.closeButton,title:"Schliessen",children:"✕"})]}):e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:P,className:x.hintButton,title:"Hinweis anzeigen",children:"💡 Hinweis"}),e.jsx("button",{onClick:q,className:`${x.solutionButton} ${_?x.locked:""}`,title:_?`Gesperrt für ${Y(N)}`:"Lösung anzeigen",disabled:_,children:_?`🔒 ${Y(N)}`:"✅ Lösung"})]})}),G&&!f&&e.jsx("button",{className:x.copyButton,onClick:M,"aria-label":"Code kopieren",title:"Code in Zwischenablage kopieren",children:y?"✓ Kopiert!":"Kopieren"})]}),f&&e.jsx("div",{className:x.progressBar,children:e.jsx("div",{className:x.progressFill,style:{width:`${V}%`}})}),z&&e.jsx(Q,{language:a,style:X,showLineNumbers:!0,wrapLines:!0,customStyle:{margin:0,borderRadius:"0 0 8px 8px",fontSize:"0.9rem"},lineNumberStyle:{minWidth:"2.5em",paddingRight:"1em",color:"#928374",userSelect:"none"},children:J}),f&&e.jsx("div",{className:x.solutionWrapper,children:e.jsx(Q,{language:a,style:X,showLineNumbers:!0,wrapLines:!0,customStyle:{margin:0,borderRadius:"0 0 8px 8px",fontSize:"0.9rem",userSelect:"none",WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none"},lineNumberStyle:{minWidth:"2.5em",paddingRight:"1em",color:"#928374",userSelect:"none"},children:Z})})]})]})}function ie(t){return typeof t=="string"?t:Array.isArray(t)?t.join(""):String(t)}function re(t){const s=t.split(`
...
console.log('Hello World!')`}})),h({type:"log",content:`Created file '${i}'`})},je=n=>{if(n.length===0){h({type:"error",content:"Usage: rm <filename>"});return}const i=n[0];if(!u[i]){h({type:"error",content:`rm: cannot remove '${i}': No such file`});return}if(i===s){h({type:"error",content:`rm: cannot remove '${i}': Initial file cannot be deleted`});return}if(y(c=>{const d={...c};return delete d[i],d}),L(c=>c.filter(d=>d!==i)),S===i){const c=Object.keys(u).filter(d=>d!==i);_(c[0]||s)}h({type:"log",content:`Removed file '${i}'`})},be=n=>{if(n.length===0){h({type:"error",content:"Usage: node <filename> [args...]"});return}const i=n[0],c=n.slice(1);if(!u[i]){h({type:"error",content:`Error: Cannot find module '${i}'`});return}Se(i,c)},Se=(n,i)=>{const c=u[n]?.content||"",d=["node",`/workspace/${n}`,...i],v=`
    ...
    `;P.current&&(P.current.srcdoc=v)},ke=()=>{G.current?.focus()},we=n=>{_(n),E.includes(n)||L(i=>[...i,n])},ve=(n,i)=>{i.stopPropagation();const c=E.filter(d=>d!==n);L(c),S===n&&c.length>0&&_(c[c.length-1])};return e.jsxs("div",{className:`${l.jsTerminalWrapper} full-width`,children:[e.jsxs("div",{className:l.mainContent,children:[e.jsxs("div",{className:l.editorSection,children:[E.length>1&&e.jsx("div",{className:l.tabBar,children:E.map(n=>e.jsxs("div",{className:`${l.tab} ${S===n?l.activeTab:""}`,onClick:()=>_(n),children:[e.jsx("span",{className:l.tabName,children:n}),E.length>1&&e.jsx("button",{className:l.closeTab,onClick:i=>ve(n,i),title:"Close",children:"×"})]},n))}),e.jsxs("div",{className:l.editorHeader,children:[e.jsx("span",{className:l.filename,children:S}),e.jsx("span",{className:l.language,children:"JavaScript"})]}),e.jsx(ze,{defaultLanguage:"javascript",value:k,theme:"vs-dark",onChange:C,height:p,options:{minimap:{enabled:!1},fontSize:14,lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0}},S)]}),Object.keys(u).length>1&&e.jsxs("div",{className:l.explorerSection,children:[e.jsx("div",{className:l.explorerHeader,children:e.jsx("span",{className:l.explorerTitle,children:"Files"})}),e.jsx("div",{className:l.explorerContent,children:Object.keys(u).sort().map(n=>e.jsxs("div",{className:`${l.explorerItem} ${S===n?l.activeExplorerItem:""}`,onClick:()=>we(n),title:n,children:[e.jsx("span",{className:l.fileIcon,children:"📄"}),e.jsx("span",{className:l.explorerFileName,children:n})]},n))})]})]}),e.jsxs("div",{className:l.terminalSection,style:{height:z},children:[e.jsxs("div",{className:l.terminalHeader,children:[e.jsx("span",{className:l.terminalTitle,children:"Terminal"}),e.jsx("span",{className:l.terminalHint,children:"Use ↑/↓ for history, Tab for completion"})]}),e.jsxs("div",{className:l.terminalContent,ref:V,onClick:ke,children:[O.map((n,i)=>e.jsx(Zn,{entry:n},i)),e.jsxs("form",{onSubmit:ue,className:l.terminalInputLine,children:[e.jsx("span",{className:l.prompt,children:"$"}),e.jsx("input",{ref:G,type:"text",className:l.terminalInput,value:A,onChange:n=>w(n.target.value),onKeyDown:me,autoComplete:"off",spellCheck:"false"})]}),e.jsx("div",{ref:q})]})]}),e.jsx("iframe",{ref:P,sandbox:"allow-scripts",style:{display:"none"},title:"code-executor"})]})}function Zn({entry:t}){const{type:s,content:g,stack:a}=t;switch(s){case"command":return e.jsxs("div",{className:l.terminalLine,children:[e.jsx("span",{className:l.prompt,children:"$"}),e.jsx("span",{className:l.commandText,children:g})]});case"log":return e.jsx("div",{className:l.terminalLine,children:e.jsx("span",{className:l.logText,children:g})});case"warn":return e.jsx("div",{className:l.terminalLine,children:e.jsx("span",{className:l.warnText,children:g})});case"error":return e.jsxs("div",{className:l.terminalLine,children:[e.jsx("span",{className:l.errorText,children:g}),a&&e.jsx("pre",{className:l.stackTrace,children:a})]});case"return":return e.jsx("div",{className:l.terminalLine,children:e.jsxs("span",{className:l.returnText,children:["← ",g]})});case"table":case"dir":return e.jsx("div",{className:l.terminalLine,children:e.jsx("pre",{className:l.structuredOutput,children:g})});case"group":return e.jsx("div",{className:l.terminalLine,children:e.jsxs("span",{className:l.groupText,children:["▼ ",g]})});case"groupEnd":return null;default:return null}}function Pn(t){return typeof t=="string"?t:Array.isArray(t)?t.join(""):String(t)}function Kn(t){const s=t.split(`
`);if(s[0]?.trim()===""&&s.shift(),s[s.length-1]?.trim()===""&&s.pop(),s.length===0)return"";const g=s.filter(a=>a.trim().length>0).reduce((a,p)=>{const z=p.match(/^\s*/)[0].length;return Math.min(a,z)},1/0);return s.map(a=>a.slice(g===1/0?0:g)).join(`
`)}function Wn(){return e.jsxs(e.Fragment,{children:[e.jsxs("section",{children:[e.jsx("h2",{children:"Bedingungen"}),e.jsx("p",{children:"Beim Programmieren kommt es ganz häufig vor, das Sie je nach Zustand des Programms, etwas unterschiedliches antworten möchten. Und dafür können Sie nicht im voraus ein eigenes Programm für jeden Fall schreiben. Also brauchen wir eine Möglichkeit wie Sie im Programm selbst eine Fallunterscheidung machen können. Das ist aber ganz einfach."}),e.jsx("p",{children:"Nehmen Sie an Sie haben ein Programm, das testen soll ob Sie bereits volljährig sind. Sie geben dem Programm über die Kommandozeile ein Alter ein. Das Programm muss dann nur noch prüfen ob das Alter über 18 ist, dann kann es eine Antwort geben, und ansonsten sagt das Programm Sie sind noch nicht volljährig. Das geht mit dem ganz einfachen Code hier:"}),e.jsx(r,{language:"javascript",children:`
          ...
          `})]}),e.jsxs("section",{children:[e.jsx("h2",{children:"Video"}),e.jsx("p",{children:"In dem Video erfahren Sie mehr über Inputhandler und auch wie Sie mehrere zu einem Spielobjekt hinzufügen können."}),e.jsx(D,{url:"J5nRtP1MAss"})]})]})}const pi=Object.freeze(Object.defineProperty({__proto__:null,default:qn},Symbol.toStringTag,{value:"Module"}));function Yn(){return e.jsxs(e.Fragment,{children:[e.jsxs("section",{children:[e.jsx("h2",{children:"Verschiedene Levels in Kaplay"}),e.jsxs("p",{children:["In einem Spiel haben Sie oft unterschiedliche Levels. Würde man das alles in eine Datei schreiben, wird das sehr unübersichtlich, und man könnte unterschiedliche Welten nicht gut voneinander trennen. In Kaplay wird das ganze mit ",e.jsx("pre",{children:"Szenen"})," geregelt."]}),e.jsx(r,{lang:"javascript",children:`
          ...
          `}),e.jsx("p",{children:"Dann können wir in unsere Hauptdatei diese Szene importieren und hinzufügen."}),e.jsx(r,{lang:"javascript",children:`
            ...
            k.go("loading")
          `})]}),e.jsxs("section",{children:[e.jsx("h2",{children:"Video"}),e.jsx("p",{children:"Hier in dem Video werden erklärt wie Szenen generell funktionieren."}),e.jsx(D,{url:"4ALgXCSkJkc"}),e.jsx("p",{children:"In diesem Video wird eine Vereinfachung der Syntax gezeigt. Sollten Sie anschauen, denn im Projekt werden beide Arten des Codes verwendet. Und der Beispiel-Code auf der Webseite hier, verwendet die einfachere Syntax vom zweiten Video."}),e.jsx(D,{url:"NCFFn_A4Gd0"})]})]})}const fi=Object.freeze(Object.defineProperty({__proto__:null,default:Yn},Symbol.toStringTag,{value:"Module"}));function Qn(){return e.jsxs(e.Fragment,{children:[e.jsxs("section",{children:[e.jsx("h2",{children:"Kaplay Komponenten"}),e.jsx("p",{children:"In Kaplay wird fast alles über Komponenten gelöst. Komponenten definieren das Aussehen und Verhalten von Spielobjekten. In dem Kapitel lernen Sie auch wie man eigene Komponenten erstellt und diese dann zum Spiel hinzufügen kann."}),e.jsx(r,{lang:"javascript",children:`
          ...
          `})]}),e.jsxs("section",{children:[e.jsx("h2",{children:"Video"}),e.jsx("p",{children:"Dieses Video erklärt Ihnen wie Sie eigene Komponenten erstellen und im Spiel verwenden können."}),e.jsx(D,{url:"QbVVgs-ncjw"})]})]})}const xi=Object.freeze(Object.defineProperty({__proto__:null,default:Qn},Symbol.toStringTag,{value:"Module"}));function Xn(){return e.jsxs(e.Fragment,{children:[e.jsxs("section",{children:[e.jsx("h2",{children:"Kaplay Ereignisse"}),e.jsx("p",{children:"Kaplay hat ein Eventsystem, das Sie bereits kennengelernt haben. Immer wenn eine Taste gedrückt wird, wird ein Event ausgelöst. Ein solches Event wird dann im nächsten Frame des Spiels verarbeitet. Also wenn ich eine Taste gedrückt halte, dann wird in jedem Frame des Spiels dieses Event ausgelöst. So können wir auch auf Kollisionen testen, oder sogar eigene Events erstellen, mit denen Objekte miteinander kommunizieren können."}),e.jsx(r,{lang:"javascript",children:`
          ...
          `})]}),e.jsxs("section",{children:[e.jsx("h3",{children:"Pull Requests"}),e.jsx("p",{children:"Wenn Ihr Feature fertig ist, erstellen Sie einen Pull Request auf GitHub. So können Ihre Teammitglieder Ihren Code überprüfen, bevor er in den Hauptbranch (main) übernommen wird."}),e.jsxs("ol",{children:[e.jsx("li",{children:"Gehen Sie zu Ihrem Repository auf GitHub"}),e.jsx("li",{children:'Klicken Sie auf "Pull requests" und dann "New pull request"'}),e.jsx("li",{children:"Wählen Sie Ihren Branch aus"}),e.jsx("li",{children:"Beschreiben Sie Ihre Änderungen"}),e.jsx("li",{children:"Bitten Sie Teammitglieder um Review"})]})]}),e.jsxs("section",{children:[e.jsx("h3",{children:"Änderungen von anderen holen"}),e.jsx("p",{children:"Bevor Sie mit der Arbeit beginnen, holen Sie immer die neuesten Änderungen vom Hauptbranch:"}),e.jsx(r,{lang:"bash",children:`
