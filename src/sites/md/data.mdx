...
<Example title="Modellieren mit Daten" classes="example">
...
<Example title="Aufgabe: Redundanz in den Daten reduzieren" classes="exercise">
...
<Example title="Beispiel: Einkaufsartikel mit Aktionen" classes="example">
...
<Example title="Aufgabe: Wieso ist Redundanz schlecht?" classes="exercise">
...
Redundanz in den Daten kann aber auch vor Datenverlust schützen. Zum Beispiel
...
nochmals prüfen müsste.

<Example title="Aufgabe: Wo it Redundanz wichtig?" classes="exercise">

Finden Sie ein Beispiel wo die Redundanz von Daten wichtig ist. Schreiben Sie
