    ...
    <>
      <section>
        ...
        <p>
          ...
          vom Spieler oder dem Spiel selbst manipuliert werden können. In Kaplay
          werden diese Spielobjekte immer auf die gleiche Art erstellt, und zwar
          mit der <pre>add()</pre>-Funktion.
        </p>
