...
export default function BYOD() {
  return (
    <>
      <h1>BYOD — Grundinstallation</h1>
      <p>
        Hier findest du die Anleitung zur Grundinstallation deines eigenen
        Geräts. Das folgende Video zeigt die Installation unter
